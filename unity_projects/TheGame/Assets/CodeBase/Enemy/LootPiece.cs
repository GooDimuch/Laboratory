...
namespace CodeBase.Enemy {
	public class LootPiece : MonoBehaviour, ISavedProgress {
		...
		public void LoadProgress(PlayerProgress progress) {
			...
			var data = progress.WorldData.LootData.LootPiecesOnScene.Dictionary[_id];
		...
		public void UpdateProgress(PlayerProgress progress) {
			...
			var lootPiecesOnScene = progress.WorldData.LootData.LootPiecesOnScene;
		...
		private void RemoveLootPieceFromSavedPieces() {
			var savedLootPieces = _worldData.LootData.LootPiecesOnScene;
